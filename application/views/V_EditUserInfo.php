...
<input type="hidden" name="user_photo_old" value="<?=$user_photo?>">
<label for="user_photo">Foto</label> <br>
<img src="<?=base_url('assets/userFiles/'.$this->session->username.'/'.$user_photo)?>" alt="">
<input type="file" name="user_photo" id="user_photo" accept="image/*" value="<?=$user_photo?>">
